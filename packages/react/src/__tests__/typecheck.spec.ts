...
test('typings', () => {
  ...
  expect(errors[15]).toMatchInlineSnapshot(`
    "packages/react/src/__tests__/__fixtures__/typings.tsx 278:44 - Type '{ css: {}; ref: RefObject<unknown>; }' is not assignable to type 'IntrinsicAttributes & Pick<{ ref?: Ref<HTMLButtonElement> | undefined; }, never> & { css?: DirtyStyle; } & { children?: ReactNode; }'.
  ...
  expect(errors[16]).toMatchInlineSnapshot(`
    "packages/react/src/__tests__/__fixtures__/typings.tsx 304:30 - Type '{ ref: RefObject<HTMLDivElement>; }' is not assignable to type 'IntrinsicAttributes & HtmlHTMLAttributes<HTMLButtonElement> & { css?: DirtyStyle; } & { children?: ReactNode; }'.
  ...
  `);
  expect(errors[17]).toMatchInlineSnapshot(`
    "packages/react/src/__tests__/__fixtures__/typings.tsx 312:28 - Type '{ ref: RefObject<HTMLDivElement>; }' is not assignable to type 'IntrinsicAttributes & Omit<ForwardStyleProps, \\"compose\\"> & { css?: DirtyStyle; } & { children?: ReactNode; }'.
